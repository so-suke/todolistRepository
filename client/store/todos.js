...
export const actions = {
  async initList(context) {
    ...
    await axios.get("http://localhost:8000/api/todo/index").then(res => {
  ...
  async add(context, payload) {
    ...
    await axios.post("http://localhost:8000/api/todo/add", params).then(res => {
  ...
  async delete(context, payload) {
    ...
    await axios.post("http://localhost:8000/api/todo/delete", params).then(res => {
  ...
  async toggle(context, payload) {
    ...
    await axios.post("http://localhost:8000/api/todo/toggleState", params).then(res => {
